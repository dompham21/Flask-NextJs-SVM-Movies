...
function Login() {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await axios.post(`http://127.0.0.1:6868/register`, values, {
        headers: {
      ...
      <main className='flex flex-col items-center justify-center w-full flex-1 px-20 text-center'>
        <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
          <div className='w-3/5 p-5'>
            ...
            <div className='py-10'>
              <h2 className='text-3xl font-bold text-green-500 mb-2'>Signup to account</h2>
            ...
            <div className='flex flex-col items-center'>
              <Form layout="vertical" autoComplete="off" className='w-2/3' onFinish={onFinish}>
                ...
                >
                    <Input.Password size='large' placeholder='Enter your confirm password...'/>
                </Form.Item>
                <div className='mt-10'>
          ...
          <div className='w-2/5 bg-green-500 text-white rounded-br-2xl py-36 px-12'>
            ...
            <Link href='/register'>
              <p className='border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-green-500'>Login</p>
            </Link>
          </div>
        </div>
